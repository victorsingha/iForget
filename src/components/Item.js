...
function Item(props) {
  ...
  return (
    <div className="md:w-2/3 shadow transition duration-500 w-11/12 cursor-pointer bg-white hover:text-gray-700 text-gray-400 font-semibold py-2 px-4 rounded hover:bg-pink-100 mt-4 mb-3">
